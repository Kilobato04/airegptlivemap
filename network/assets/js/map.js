...
setTimeout(() => {
    ...
    function initializeLegend() {
        ...
        if (toggleSMAAButton) {
            ...
            toggleSMAAButton.addEventListener('click', () => {
                ...
                if (smaaNetworkVisible) {
                    ...
                    map.setLayoutProperty('smaa_network', 'visibility', 'none');
        ...
        // Función helper para actualizar estilos de botones
        ...
        map.on('click', 'smaa_network', async (event) => {
            ...
            if (APP_SETTINGS.activeStations.includes(feature.properties.name)) {
                ...
                const masterAPIStations = [
                    ...
                    'INSYC-Smability', 'Hipódromo', 'La Diana', 'UNAM - ICAYCC', 'UAM', 'Tepeji', // ← NUEVAS
