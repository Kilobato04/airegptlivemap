...
function createPopupContent(feature, sensorData) {
    ...
    if (APP_SETTINGS.activeStations.includes(name)) {
        ...
        if (sensorData && sensorData.dataIAS !== 'N/A') {
            ...
            // Historical Data Link - SIN FONDO EXTRA, usa el fondo IAS
            html += '<div class="reading" style="margin-top: 4px; width: 100%;">';
            html += '<a href="#" class="chart-link" onclick="toggleChartPanel(event, \'' + feature.properties.name + '\')" style="background-color: transparent; color: #000; border: 2px solid #000;">';
            ...
            // Contact Links - SIN FONDO EXTRA, usa el fondo IAS
            ...
            html += '<div style="margin-top: 4px; display: flex; align-items: center; justify-content: center; gap: 8px; border: 2px solid #25D366; padding: 8px; border-radius: 8px; background-color: transparent; cursor: pointer;">';
            ...
            html += '<span style="font-size: 0.9em; color: #000; font-weight: bold;">Chat with AIreGPT</span>';
            html += '</div>';
            html += '</a>';
            
            // Footer info - SIN FONDO EXTRA, usa el fondo IAS
            html += '<div style="margin-top: 8px; background-color: transparent; padding: 5px;">';
            html += '<small style="color: #000; font-weight: bold;">Last updated: ' + new Date().toLocaleTimeString() + '</small><br>';
            html += '<small><a href="' + APP_SETTINGS.brandUrl + '" target="_blank" class="brand-text" style="color: #000; font-weight: bold;">smability.io</a></small>';
            html += '</div>';
